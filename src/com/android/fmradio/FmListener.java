...
public interface FmListener {
    ...
    /**
        * record success start (it means,what
        * mediamuxer was initialized successfully,so recording will be exactly started).
        */
    ...
    // Check,whether we should start recording after saving.
